...
KNOWLEDGE = {
    ...
    "the dark side of the moon": {
        "astronomy domine": "An early Syd Barrett-era track appearing on this collection as part of the extended Pink Floyd story. Barrett's cosmic imagery and the dueling guitars established Pink Floyd's psychedelic credentials from their very first single.",
        "see emily play": "Syd Barrett's whimsical, kaleidoscopic single — the band's commercial breakthrough before Barrett's mental health deteriorated. The backward guitar effects and fairytale lyrics captured London's psychedelic underground at its most innocent.",
        "the happiest days of our lives": "Roger Waters' chilling childhood memory of abusive teachers, building tension with its whispered menace before the cathartic explosion into 'Another Brick in the Wall, Pt. 2.' Listen for the helicopter sound effect — Waters' recurring sonic motif for authoritarian oppression.",
        "another brick in the wall, pt. 2": "Pink Floyd's only US #1 single, with its unforgettable disco-influenced beat and the children's choir chanting anti-education slogans. Producer Bob Ezrin brought in the kids from a nearby school, and the driving bassline from David Gilmour makes this the funkiest moment in Floyd's catalog.",
        "echoes (edit)": "The abridged version of Floyd's 23-minute epic from Meddle, where the full band achieved a telepathic level of interplay. The ping-sonar piano note — accidentally discovered by Rick Wright — became the seed around which the entire piece grew.",
        "hey you": "A desperate plea from isolation, positioned at the start of the album's second half with no preceding buildup — just Gilmour's solitary acoustic guitar. The unanswered call for connection ('Hey you, out there in the cold') captures The Wall's central theme of self-imposed isolation.",
        "marooned (excerpt)": "An instrumental featuring Gilmour's signature whale-song guitar, played through a DigiTech Whammy pedal to bend notes into impossible shapes. Won a Grammy for Best Rock Instrumental — the only Pink Floyd track to do so.",
        "the great gig in the sky": "Clare Torry's improvised wordless vocal — she was a session singer brought in for a single take, paid £30, and created one of rock's most transcendent moments. The vocal moves from sensual to anguished to ecstatic, mapping a soul's journey that words could never capture.",
        "set the controls for the heart of the sun": "Roger Waters' Eastern-influenced meditation, the only Floyd song to feature all five members (including Syd Barrett in spirit). Nick Mason's mallet percussion and the hypnotic bass drone create a trance-like atmosphere that made this a staple of their early psychedelic light shows.",
        "money": "The instantly recognizable cash-register loop — created by splicing actual sounds from Roger Waters' coin collection — opens Floyd's funkiest track. The 7/4 time signature (unusual for rock) gives the groove a lurching, off-kilter feeling, while Dick Parry's saxophone solo channels urban sleaze.",
        "keep talking": "Features spoken word samples of Stephen Hawking from a British Telecom commercial. Gilmour's talk-box guitar — literally speaking through his instrument — responds to Hawking's voice, creating a dialogue about the fundamental human need to communicate.",
        "sheep": "Waters' reworking of Psalm 23 into a furious anti-fascist anthem, with its bleating sheep-baa guitar effects created by Gilmour running his bass through an effects pedal. The slow build from pastoral acoustic to punk fury mirrors the lyrical journey from complacency to uprising.",
        "sorrow": "The closing track of A Momentary Lapse of Reason, with its galloping drum intro recorded in a Los Angeles sports arena for maximum reverb. Gilmour's soaring, multi-layered guitar finale — built from dozens of overdubs — is arena-rock guitar at its most cinematic.",
        "time": "Nick Mason's rototom intro — recorded in an antique clock shop — gives way to one of rock's most devastating meditations on mortality. Gilmour's searing guitar solo and Wright's soulful vocals on the reprise section ('Home, home again') were recorded in just a few takes.",
        "learning to fly": "David Gilmour's first Floyd single after Waters' departure, co-written with new members and featuring Jon Carin's pulsing keyboard sequence. The song's theme of mastering flight — literal and metaphorical — addressed the band's uncertainty about surviving without Waters.",
        "arnold layne": "Syd Barrett's debut single, a witty, empathetic portrait of a cross-dressing clothes thief — shocking enough for 1967 that the BBC banned it. The catchy, almost nursery-rhyme melody belied the subversive subject matter, establishing Floyd as intellectual provocateurs.",
        "wish you were here": "The album's emotional core, with its acoustic intro — originally played on a radio through Gilmour's car speakers while recording — and direct, unadorned lyrics about absence and loss. Written about Syd Barrett's mental decline, it has become a universal song of missing someone.",
        "jugband blues": "Syd Barrett's final official Pink Floyd recording, a chaotic Salvation Army band arrangement that captures his deteriorating mental state in real time. The manic energy and disjointed structure feel like a mind coming apart — a haunting farewell to the band's founding visionary.",
        "high hopes (edit)": "The album-closing epic from The Division Bell, featuring Gilmour's lap steel guitar and a full orchestra. The backward-masked final sound is a voice saying 'hello Charlie' — a playful nod to Barrett — before a distant bell tolls, closing the Pink Floyd story.",
        "bike (edit)": "Syd Barrett's whimsical closing track from Piper at the Gates of Dawn, with its surreal list of gifts offered to a girl — a mouse named Gerald, a cloak of 'sights and sounds,' a gingerbread man. The song's childlike logic and Barrett's distinctive London accent capture the innocent psychedelia of 1967.",
    },
    "the wall": {
