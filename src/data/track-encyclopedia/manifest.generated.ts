...
export const trackEncyclopediaAlbums = {
  ...
  "007-fleetwood-mac-rumours-bc57e04c": {
    ...
    editionNumber: 1,
    contentHash: "60db2f9ccccfa002",
    objectHash: "f5858be0fadccba67ace1e50494045a2778666a0e58ab2f421019cb3976d929d",
    trackCount: 11,
    releaseHash: "be0dde5d9b55407a",
    editionPath: "objects/albums/f5858be0fadccba67ace1e50494045a2778666a0e58ab2f421019cb3976d929d.json",
    load: async () => { const response = await fetch(new URL("./objects/albums/f5858be0fadccba67ace1e50494045a2778666a0e58ab2f421019cb3976d929d.json", import.meta.url), { cache: "no-store" }); if (!response.ok) throw new Error(`Track encyclopedia request failed: ${response.status}`); return (await response.json()) as TrackEncyclopediaAlbumEntry; },
  },
